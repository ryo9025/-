...
#define MT_MAX     (0xFF)    //!< @brief モーターへの出力最大値
#define MT_MIN     (0x00)    //!< @brief モーターへの出力最小値
...
#define AI_CH      (5)       //!< @brief アナログ入力のチャンネル数
#define PI_CH      (1)       //!< @brief パルス入力のチャンネル数
#define DI_CH      (1)       //!< @brief デジタル出力のチャンネル数
#define DO_CH      (0)       //!< @brief デジタル入力のチャンネル数
#define PWM_CH     (10)      //!< @brief PWM出力のチャンネル数
...
#pragma comment(lib, "TPGC_12.lib")
#pragma comment(lib, "TPGM_12.lib")
#pragma comment(lib, "TPUD_13.lib")
#pragma comment(lib, "TPJT216_15.lib")
